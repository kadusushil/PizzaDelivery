 ...
 **/
 helpers.sendEmail = (email, subject, text, callback) => {
   ...
   const payload = {
     'from' : 'Mailgun Sandbox <postmaster@sandbox62aedc2aa01444bda3b9afe35376ac08.mailgun.org>',
     'to' : email,
     'subject' : subject,
     'text' : text
   }
   ...
   const requestDetails = {
     ...
     'method' : 'POST',
     'path' : '/v3/sandbox62aedc2aa01444bda3b9afe35376ac08.mailgun.org/messages',
     'headers' : {
         'Content-Type' : 'application/x-www-form-urlencoded',
         'Content-Length': Buffer.byteLength(stringPayload),
         'Authorization': 'Basic YXBpOjhhYzBlMGZmMGIxYTJjOTQzNDk5OTJkMDc2MjdkY2JmLTdiYmJjYjc4LTQwNmIyZTJk',
     }
   }
